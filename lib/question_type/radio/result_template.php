    ...
    <thead>
        ...
        <?php foreach ($structure as $s_index=>$header_matriz): ?>
            ...
            <th class="header-text">
                ...
                <input onclick="radio_load_frecuence(this);" type="checkbox" checked="checked" class="" name="" value="radio<?php echo $s_index."_".$h_index;?>" />
            </th>
            <?php endforeach; ?>
    ...
    <tbody>
        <tr class="items odd">
            <?php foreach ($h as $s_h_index=>$header_values): ?>
                ...
                <td class="item-option radio<?php echo $s_h_index."_".$k_header_text ?> ">
                ...
                <?php endforeach; ?>
                <td class="item-option last_group total-column-radio result-<?php echo $s_h_index;?>">
